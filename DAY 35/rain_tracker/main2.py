...
#         self.iconbitmap(r"/python/100 Days of Code/DAY 35/rain_tracker/Image/weather_icon.ico")
...
#        self.img=Image.open(r"/python/100 Days of Code/DAY 35/rain_tracker/Image/black_border.png")
...
#        self.img1=Image.open(r"/python/100 Days of Code/DAY 35/rain_tracker/Image/search_btn.png")
...
#        # location image logo
#        self.img2=Image.open(r'/python/100 Days of Code/DAY 35/rain_tracker/Image/location.png')
...
#        self.img3=Image.open(r"/python/100 Days of Code/DAY 35/rain_tracker/Icons/main.png")
...
#        # sunrise logo
#        self.finalimg4=ImageTk.PhotoImage(image=Image.open(r"/python/100 Days of Code/DAY 35/rain_tracker/Image/sunrise.png").resize((40,40)))
...
#        #sunset logo
#        self.finalimg5=ImageTk.PhotoImage(image=Image.open(r"/python/100 Days of Code/DAY 35/rain_tracker/Image/sunset.png").resize((40,30)))
...
#        # bottom bar
#        self.finalimg6=ImageTk.PhotoImage(image=Image.open(r'/python/100 Days of Code/DAY 35/rain_tracker/Image/bottom_bar.png').resize((770,70)))
...
#             config_file.read("api_key")
#             api=config_file['Openweather']['api']
#             # Corrected: Use the entered city in the API request
#             data=f'https://api.openweathermap.org/data/2.5/weather?q= Bokaro India&appid=f4edca8a6ed432a628123bab605146ba'
...
#         except Exception as e: # Catch a more general exception to see other errors
#             messagebox.showerror('Error',f"Some Errored Occured: {e}\nTry again Later!")
        
#     def __set_information(self,weather):
#         # print(weather)
#         if weather.get('cod')=='404' and weather.get('message')=='city not found': # Use .get() for safer dictionary access
#             messagebox.showerror("Error","Entered City Not Found")
#             self.search.set("")
#         elif weather.get('cod')=='400' and weather.get('message')=='Nothing to geocode': # Use .get() for safer dictionary access
...
#             if result: # Check if a timezone was found
#                 home=pytz.timezone(result)
#                 local=datetime.datetime.now(home).strftime("%d/%m/%y  %I:%M %p")
#                 self.timelbl['text']=local
#             else:
#                 self.timelbl['text'] = "N/A" # Handle cases where timezone isn't found
...
#             self.humidity['text']=f"{weather['main']['humidity']}%" # Formatted as string
#             self.pressure['text']=f"{weather['main']['pressure']} mBar" # Formatted as string
#             self.location.config(text=weather['name'])
#             self.vis['text']=f"{int(weather['visibility']/1000)} km" # Formatted as string
...
#         if type=="Clear":
#             img="/python/100 Days of Code/DAY 35/rain_tracker/Icons/clear.png"
#             self.set_image(img)
#         elif type=="Clouds":
#             img='/python/100 Days of Code/DAY 35/rain_tracker/Icons/clouds.png'
#             self.set_image(img)
#         elif type=="Rain":
#             img='/python/100 Days of Code/DAY 35/rain_tracker/Icons/rain.png'
#             self.set_image(img)
#         elif type=='Haze':
#             img='/python/100 Days of Code/DAY 35/rain_tracker/Icons/haze.png'
#             self.set_image(img)
#         else:
#             img='/python/100 Days of Code/DAY 35/rain_tracker/Icons/main.png'
#             self.set_image(img)
    
#     def set_image(self,img):
#        # Corrected line: 'img' already contains the full relative path
#        self.img3=Image.open(img)
#        self.resizeimg3=self.img3.resize((190,190))
#        self.finalimg3=ImageTk.PhotoImage(self.resizeimg3)
#        self.icons.config(image=self.finalimg3) # Use config to update existing label
#        # self.icons.place(x=70,y=110) # No need to re-place, just update image
...
class Weather(Tk):
    ...
    def __get_weather(self):
        try:
            # Use "Bokaro, India" directly
            # city_query = "Bokaro, India" 
            # api = "766622b67002134fcd92e73c036c7ecf"
            
            data = f'https://api.openweathermap.org/data/2.5/weather?q=India&appid="766622b67002134fcd92e73c036c7ecf"'
            weather = requests.get(data).json()
            self.__set_information(weather=weather)
