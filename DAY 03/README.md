...
- Comparison operators (`>`, `<`, `>=`, `<=`, `==`, `!=`) and how they return booleans
- Nesting `if` statements to handle multiple, dependent decisions
- Using `elif` chains to check a value against several ranges cleanly
- Logical operators (`and`, `or`, `not`) for combining conditions
- Designing a branching decision tree before writing the code
