...
- Python's core data types: `str`, `int`, `float`, `bool`
- Converting between types with `int()`, `float()`, `str()`, `bool()`
- Arithmetic operators and PEMDAS order of operations
- `round()` for formatting numbers, including to a fixed number of decimal places
- f-strings for clean, readable output formatting
