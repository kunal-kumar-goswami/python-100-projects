...
class Weather(Tk):
    ...
    def __get_weather(self):
        try:
            ...
            data=f'https://api.openweathermap.org/data/2.5/weather?q=India&appid=f4edca8a6ed432a628123bab605146ba'
    ...
    def set_image(self,img):
       self.img3=Image.open(f"/python/100 Days of Code/DAY 35/rain_tracker/Icons,{img}")
